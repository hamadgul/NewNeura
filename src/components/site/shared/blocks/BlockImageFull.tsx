 ...
 *
 * Used across the site: /process/ (673px tall at 1440) and instances on
 ...
 *
 *   /process/   673.188/1440 = 359.031/768 = 182.312/390 = 0.46749  (1600x748)
 ...
 *
 * Note this block is deliberately *not* wrapped in `.ng-image-reveal`. The
...
export function BlockImageFull({ image, priority = false, className }: BlockImageFullProps) {
  return (
    ...
    <div className={cn("blockImageFull ng-grid my-[100px] xl:my-[120px]", className)}>
