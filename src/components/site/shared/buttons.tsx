/**
 * Shared button primitives, ported 1:1 from the reference theme stylesheet.
 *
...
interface ButtonCircleProps {
  href?: string;
  /** `service` paints from `--serviceContentColor`, inherited from the card. */
  color?: "black" | "white" | "service";
  className?: string;
  icon?: ReactNode;
  label: string;
  asStatic?: boolean;
