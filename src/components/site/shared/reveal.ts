 ...
 *
 * Measured at 390×664 by stepping the page down 60px at a time and
 ...
 *      `664 / 0.15 ≈ 4.4k` px can never reach 15%. A ~5000px-tall collection
 *      section at 390px could never reach 15%, so its header sat at
 *      `opacity: 0` for the whole page — permanently invisible. Sections get taller as the viewport
