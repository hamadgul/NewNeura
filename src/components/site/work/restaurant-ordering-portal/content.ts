 ...
 * `docs/research/case-studies/restaurant-ordering-portal.md`.
 *
 ...
 * (`BlockImageFull`), and re-rendering `pizzeria.jpg` through one would be
 ...
 * those three rows read (Year | Platform) then (Live demo | —, its column
