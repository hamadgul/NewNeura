 ...
 *  - The scroll reveal (`.lpas-image-reveal`) is a one-shot clip-path wipe
    ...
    >
      ...
      <div className="imageCard__textWrap mt-[15px] flex flex-col gap-[2px]">
        {/*
          ...
          Measured on /markets/housing/student-housing/, a one-line title is
          21.59px and "West Valley-Mission Community College District Housing
          Initiative" is 43.19px — two full lines. A fixed `h-[22px]` (which the
          homepage never exposed, since every title there is one line) clipped
          the second line off on every page with a long project name.
        */}
