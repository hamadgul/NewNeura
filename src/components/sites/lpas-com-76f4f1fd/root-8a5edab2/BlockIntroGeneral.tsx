...
/**
 * "Clear Process..." intro block from the lpas.com homepage.
 *
 ...
 *
 * Grid math (from getComputedStyle at 1440x900, `.lpas-grid`'s 20-col tier
...
export function BlockIntroGeneral() {
  ...
  return (
    <section
      ref={sectionRef}
      className="blockIntroGeneral lpas-grid my-[50px] text-[#111111] xl:my-[60px]"
    >
      <h2
        className={cn(
          revealClass,
