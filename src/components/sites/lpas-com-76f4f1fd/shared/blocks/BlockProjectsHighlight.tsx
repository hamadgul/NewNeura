 ...
 *
 *   /                                       one, two
 *   /markets/housing/                       one, five, three
 *   /markets/housing/affordable-housing/    five, three
 *   /markets/housing/market-rate-housing/   four, five, two
 *   /markets/housing/student-housing/       two
 *   /markets/housing/senior-housing/        two
 *   /markets/civic/                         four, three
 *   /markets/commercial/                    four, three
 *   /markets/interiors/                     one, three
 *   /markets/higher-education/              one, two
 *
 ...
 *   market-rate        "Highlighted projects" · "All Market Rate Housing"
...
import { ImageCard } from "@/components/sites/lpas-com-76f4f1fd/root-8a5edab2/ImageCard";
import { usePrefersReducedMotion } from "@/hooks/useMediaQuery";
import { cn } from "@/lib/utils";
import type { PortfolioFilterItem, ProjectCard } from "@/types/lpas";
...
export interface BlockProjectsHighlightProps {
  ...
  /** The homepage's "See our focus cases" pill row. Market pages pass nothing. */
 ...
 *       <div .lpas-image-reveal> ← 1.2s one-shot clip-path wipe
 *         <img>                  ← 0.3s repeatable hover scale
 *
 * Watching the anchor rather than the reveal wrapper is load-bearing:
 * `.lpas-image-reveal` starts at `clip-path: inset(100% 0 0)`, so an observer
  ...
  return (
    ...
    >
      <div className={NOTCH_CLASS[notch]}>
        <div
          className={cn(
            "imageCard__imageWrapper lpas-image-reveal flex items-center justify-center overflow-hidden",
      ...
      <div className="imageCard__textWrap mt-[15px] flex flex-col gap-[2px]">
        {/* `min-h`, not `h`: the source's title box is content-driven. A
            ...
            line off on every market page. Same fix as ImageCard.tsx. */}
...
export function BlockProjectsHighlight({
  ...
  return (
    <section className={cn("blockProjectsHighlight lpas-grid my-[100px] text-[#111111]", className)}>
