/**
 * `BlockHeaderPortfolio` — the compact page header used by `/portfolio/` and
 * `/latest/`.
 *
 ...
 *  - The content layer is a column subgrid of `.lpas-grid` with three rows:
...
export interface BlockHeaderPortfolioImage {
  /** Local path, e.g. `/sites/lpas-com-76f4f1fd/portfolio-81ee5030/images/foo.webp`. */
  src: string;
...
export function BlockHeaderPortfolio({
  ...
  return (
    <header
      ...
      className={cn("blockHeaderPortfolio lpas-grid", className)}
    >
      {/*
      ...
      */}
      <div className="blockHeaderPortfolio__content relative z-10 row-start-1 grid h-[50vh] max-h-[650px] grid-cols-subgrid grid-rows-[103px_27px_1fr] [grid-column:full-start/full-end] md:grid-rows-[1fr_27px_1fr]">
        ...
        <span className="blockHeaderPortfolio__textLeft font-S block self-center text-white [grid-column:main-start/span_3]">
          {eyebrow}
        </span>
        ...
        */}
        <span className="blockHeaderPortfolio__textRight font-S block self-center justify-self-end text-right lowercase text-white first-letter:uppercase [grid-column:span_2/main-end] md:[grid-column:span_3/main-end]">
          {label}
        </span>
        ...
        */}
        <h1 className="blockHeaderPortfolio__title font-3XL flex items-end pb-[35px] text-white [grid-column:main-start/main-end] md:[grid-column:main-start/span_7]">
        ...
        <div className="blockHeaderPortfolio__buttonWrapper mb-[35px] flex self-end justify-self-end [grid-column:span_1/main-end]">
