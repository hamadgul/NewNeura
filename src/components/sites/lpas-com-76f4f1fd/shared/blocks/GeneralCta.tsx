...
/**
 * GeneralCta — the small call-to-action band that closes /culture/.
 *
 ...
 *
 * Grid math (GRID_AREAS.json at 1440 / 768 / 390 — `.lpas-grid`'s `main-start`
...
export function GeneralCta({ text, label, href, className }: GeneralCtaProps) {
  ...
  return (
    <section
      ref={sectionRef}
      className={cn(
        "generalCta lpas-grid my-[100px] text-[16px] leading-[21.6px] text-[#111111] xl:my-[120px]",
        className,
      )}
    >
      <div
