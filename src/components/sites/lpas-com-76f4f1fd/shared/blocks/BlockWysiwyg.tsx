 ...
 * detail pages, and every /markets/… sub-page).
 *
 ...
 *   2. Tagline + title + body (all the market sub-pages) — an eyebrow with a
 ...
 * 1440 / 768 / 390 — `.lpas-grid`'s named lines put `main-start` at numeric
 ...
 * instances on /markets/housing/affordable-housing/ at 390px, the collapsed
...
/**
 * A `<p>` inside the rich text. The market pages use a `<strong>` lead-in, a
...
/**
 * A pull-quote testimonial. Measured on `/markets/higher-education/`'s "Client
  ...
  return (
    <section
      ...
      className={cn(
        ...
        "blockWysiwyg lpas-grid my-[50px] text-[16px] leading-[21.6px] text-[#111111] xl:my-[60px]",
        className,
      )}
    >
      {tagline ? (
