import {
  ...
  WYSIWYG_EXPERTISE,
  WYSIWYG_WHY_LPAS,
} from "@/components/sites/lpas-com-76f4f1fd/markets-housing-senior-housing-c6469d9f/content";
...
/**
 * The source serves "Senior Housing - LPAS Architecture" — exactly what the root
 * layout's `"%s - LPAS Architecture"` template produces from "Senior Housing", so
...
/**
 * `/markets/housing/senior-housing/` — one of the four Housing child markets.
 *
 ...
 */
export default function MarketsHousingSeniorHousingPage() {
  return (
    <>
      <MainNavigation />
