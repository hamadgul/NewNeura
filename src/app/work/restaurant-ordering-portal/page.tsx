...
/**
 * The live title is "Restaurant ordering portal — NeuraGul", which is exactly
 * the root layout's "%s — NeuraGul" template applied to the project name, so
 * the plain (non-absolute) form is correct here. The description is the
 * project's own `brief`.
 */
 ...
 * scrolled past, which reads as padding because it is.
 *
