 ...
 * reason: one asset and three sentences. The one screenshot is the header's
 * full-bleed backdrop, so there is no `BlockImageFull` and no media block —
 * either would re-render the picture the reader has just scrolled past.
 *
 * A second screenshot would earn a media block here (the site has ten pages
 * worth photographing) — that is the upgrade path if this case study is ever
 * worth more room.
 *
